...
import com.ai.domain.bo.wx.WeixinUser;
import com.ai.domain.bo.wx.WeixinUserList;
...
public class AdvancedUtil {
	...
	public static WeixinUserList getWeixinUserList(String accessToken, String nextOpenId) {
		...
		// 获取用户列表
		String respJSON = WX_CommonUtil.httpsRequest(requestUrl, "GET", null);
...
//		// 发送模板消息
//		String respJSON = WX_CommonUtil.httpsRequest(requestUrl, "POST",
//				template.toJSON());
//		System.out.println("respJSON:" + respJSON);
//		JSONObject jsonObject = JSONObject.fromObject(respJSON);
//		if (null != jsonObject) {
...
//	}
	...
	public static boolean sendTemplateMessage(String accessToken,String template) {
		...
		System.out.println("1accessToken: " + accessToken);
		// 发送模板消息
		String respJSON = WX_CommonUtil.httpsRequest(requestUrl, "POST", template);
		System.out.println("respJSON:" + respJSON);
		JSONObject jsonObject = JSONObject.fromObject(respJSON);
		if (null != jsonObject) {
			int errorCode = jsonObject.getInt("errcode");
